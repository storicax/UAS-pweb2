...
if(isset($_SESSION['username'])){
    header('location: admin.php');//jika belum login jangan lanjut
}
...
<div class="container" style="margin-top: 50px">
    <div class="row">
        <div class="col-sm-6 col-md-4 col-md-offset-4">
            <h1 class="text-center login-title">Login N2VL</h1>
           
            <div class="account-wall">
                <img class="profile-img" src="https://lh5.googleusercontent.com/-b0-k99FZlyE/AAAAAAAAAAI/AAAAAAAAAAA/eu7opA4byxI/photo.jpg?sz=120"
                    alt="">    
                <form class="form-signin" method="POST" action="proses/proseslogin.php">
            ...
            <a href="daftar.php" class="text-center new-account">Buat Akun </a>
